...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  cnpj VARCHAR(15) DEFAULT 'Preencher',
...
async function createTablesAndSeed() {
  ...
  try {
    ...
    const { rows } = await client.query(
      `INSERT INTO usuarios (email, nome, nome_fantasia, papel, senha_hash) VALUES
       ('admin@exemplo.com', 'Administrador', 'Admin True', 'administrador', $1),
       ('fornecedor@exemplo.com', 'Fornecedor Teste', 'Fornecedor True', 'fornecedor', $1),
       ('representante@exemplo.com', 'Representante Teste','Representante True', 'representante', $1),
       ('lojista@exemplo.com', 'Lojista Teste','Lojista True', 'lojista', $1)
       RETURNING id, papel`,
      [hash]
    );
