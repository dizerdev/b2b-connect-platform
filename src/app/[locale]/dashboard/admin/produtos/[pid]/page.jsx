    ...
    <AdminGuard>
      <div className='p-6 space-y-6'>
            ...
            <table className='w-full border border-gray-200'>
              <thead>
                <tr className='bg-gray-100'>
                  ...
                  <th className='border px-2 py-1 text-left'>{t('ReadyDelivery')}</th>
                  <th className='border px-2 py-1 text-left'>{t('Stock')}</th>
                  <th className='border px-2 py-1 text-left'>{t('CreatedAt')}</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className='bg-white shadow rounded p-4 space-y-4'>
          <h2 className='text-lg font-semibold'>{t('ActionsSection')}</h2>
